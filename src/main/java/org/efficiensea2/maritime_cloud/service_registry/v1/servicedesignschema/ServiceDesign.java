...
public class ServiceDesign {
    ...
    public static class OffersTransport {
        ...
        @XmlElement(required = true)
        protected List<Transport> offersTransport;
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the offersTransport property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getOffersTransport().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<Transport> getOffersTransport() {
            if (offersTransport == null) {
                offersTransport = new ArrayList<Transport>();
            }
