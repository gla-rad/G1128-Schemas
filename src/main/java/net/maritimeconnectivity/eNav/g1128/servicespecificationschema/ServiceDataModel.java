...
public class ServiceDataModel {
    ...
    /**
     * Only used if not S-100 compliant. The definition of the service data model
     * described.
     */
    protected String modelDefinition;
    /**
     * Only used if not S-100 compliant. The encoding of the attribute modelDefinition.
     */
