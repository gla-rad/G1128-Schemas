...
public class Transport {
    ...
    /**
     * Human readable description of the transport protocol used by the service design.
     */
    @XmlElement(required = true)
    protected String description;
    /**
     * A non-formal string representation of the transport. (e.g. http/rest, http/soap,.. )
     * that provides enough information to a service consumer to be able to connect.
     */
    @XmlElement(required = true)
