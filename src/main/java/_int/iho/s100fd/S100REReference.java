...
public class S100REReference {
    ...
    protected List<String> referenceIdentifier;
     ...
     * This is why there is not a <CODE>set</CODE> method for the referenceIdentifier property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getReferenceIdentifier().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getReferenceIdentifier() {
        if (referenceIdentifier == null) {
            referenceIdentifier = new ArrayList<String>();
        }
