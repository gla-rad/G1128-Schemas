...
public class S100CDEnumeratedValueConcepts {
     ...
     * This is why there is not a <CODE>set</CODE> method for the s100CDEnumeratedValueConcepts property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getS100CDEnumeratedValueConcepts().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     * @return list of S100CDEnumeratedValueConcept
     */
    public List<S100CDEnumeratedValueConcept> getS100CDEnumeratedValueConcepts() {
        if (s100CDEnumeratedValueConcepts == null) {
            s100CDEnumeratedValueConcepts = new ArrayList<S100CDEnumeratedValueConcept>();
        }
